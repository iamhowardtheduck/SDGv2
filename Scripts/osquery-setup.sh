...
wait_for_dpkg_lock
apt-get install -y curl iputils-ping gnupg lsb-release wget software-properties-common jq gdebi-core -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"
